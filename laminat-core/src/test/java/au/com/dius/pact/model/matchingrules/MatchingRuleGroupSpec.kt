    ...
    "matchers lookup returns #matcherClass.simpleName #condition" {
        ...
        forAll(
            table(
                ...
                row(
                    Json.Object("match" to Json.StringPrimitive("type"), "max" to Json.NumberPrimitive(3), "min" to Json.NumberPrimitive(2)),
                    MinMaxTypeMatcher::class,
                    "if the matcher definition contains both a min and max"
                ),
